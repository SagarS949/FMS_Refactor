...
{
    strcpy_s(F[0].Flight_Number,"6E0234");
    strcpy_s(F[0].Flight_Company,"Indigo");
    strcpy_s(F[0].Source,"MUMBAI");
    strcpy_s(F[0].Destination,"DELHI");
    strcpy_s(F[0].Flight_Type,"Domestic");
    F[0].Date_Of_Journey.day = 20;
    F[0].Date_Of_Journey.month = 11;
    F[0].Date_Of_Journey.year = 2023;
    strcpy_s(F[0].Departure_Time,"08:35");
    strcpy_s(F[0].Arrival_Time,"10:55");
    strcpy_s(F[0].Duration,"2:20");
    ...
    strcpy_s(F[1].Flight_Number,"AI1256");
    strcpy_s(F[1].Flight_Company,"Air India");
    strcpy_s(F[1].Source,"CHENNAI");
    strcpy_s(F[1].Destination,"BANGALORE");
    strcpy_s(F[1].Flight_Type,"Domestic");
    F[1].Date_Of_Journey.day = 23;
    F[1].Date_Of_Journey.month = 3;
    F[1].Date_Of_Journey.year = 2023;
    strcpy_s(F[1].Departure_Time,"13:35");
    strcpy_s(F[1].Arrival_Time,"15:00");
    strcpy_s(F[1].Duration,"1:25");
    ...
    strcpy_s(F[2].Flight_Number,"G80993");
    strcpy_s(F[2].Flight_Company,"Go Air");
    strcpy_s(F[2].Source,"BANGALORE");
    strcpy_s(F[2].Destination,"DELHI");
    strcpy_s(F[2].Flight_Type,"Domestic");
    F[2].Date_Of_Journey.day = 13;
    F[2].Date_Of_Journey.month = 6;
    F[2].Date_Of_Journey.year = 2023;
    strcpy_s(F[2].Departure_Time,"23:35");
    strcpy_s(F[2].Arrival_Time,"02:15");
    strcpy_s(F[2].Duration,"2:40");
    ...
    strcpy_s(F[3].Flight_Number,"AI9317");
    strcpy_s(F[3].Flight_Company,"Air India");
    strcpy_s(F[3].Source,"MUMBAI");
    strcpy_s(F[3].Destination,"CHENNAI");
    strcpy_s(F[3].Flight_Type,"Domestic");
    F[3].Date_Of_Journey.day = 17;
    F[3].Date_Of_Journey.month = 12;
    F[3].Date_Of_Journey.year = 2023;
    strcpy_s(F[3].Departure_Time,"12:00");
    strcpy_s(F[3].Arrival_Time,"13:25");
    strcpy_s(F[3].Duration,"1:25");
    ...
    strcpy_s(F[4].Flight_Number,"AX0966");
    strcpy_s(F[4].Flight_Company,"Air India Express");
    strcpy_s(F[4].Source,"MUMBAI");
    strcpy_s(F[4].Destination,"BANGALORE");
    strcpy_s(F[4].Flight_Type,"Domestic");
    F[4].Date_Of_Journey.day = 30;
    F[4].Date_Of_Journey.month = 9;
    F[4].Date_Of_Journey.year = 2023;
    strcpy_s(F[4].Departure_Time,"16:45");
    strcpy_s(F[4].Arrival_Time,"18:05");
    strcpy_s(F[4].Duration,"1:20");
    ...
    strcpy_s(F[5].Flight_Number,"SQ0598");
    strcpy_s(F[5].Flight_Company,"Singapore Airlines");
    strcpy_s(F[5].Source,"BANGALORE");
    strcpy_s(F[5].Destination,"SINGAPORE");
    strcpy_s(F[5].Flight_Type,"International");
    F[5].Date_Of_Journey.day = 23;
    F[5].Date_Of_Journey.month = 1;
    F[5].Date_Of_Journey.year = 2024;
    strcpy_s(F[5].Departure_Time,"12:45");
    strcpy_s(F[5].Arrival_Time,"18:55");
    strcpy_s(F[5].Duration,"6:10");
    ...
    strcpy_s(F[6].Flight_Number,"QF4398");
    strcpy_s(F[6].Flight_Company,"Qantas");
    strcpy_s(F[6].Source,"DELHI");
    strcpy_s(F[6].Destination,"LONDON");
    strcpy_s(F[6].Flight_Type,"International");
    F[6].Date_Of_Journey.day = 5;
    F[6].Date_Of_Journey.month = 10;
    F[6].Date_Of_Journey.year = 2023;
    strcpy_s(F[6].Departure_Time,"05:30");
    strcpy_s(F[6].Arrival_Time,"13:25");
    strcpy_s(F[6].Duration,"7:55");
    ...
    strcpy_s(F[7].Flight_Number,"BA0919");
    strcpy_s(F[7].Flight_Company,"British Airways");
    strcpy_s(F[7].Source,"DELHI");
    strcpy_s(F[7].Destination,"LONDON");
    strcpy_s(F[7].Flight_Type,"International");
    F[7].Date_Of_Journey.day = 1;
    F[7].Date_Of_Journey.month = 11;
    F[7].Date_Of_Journey.year = 2023;
    strcpy_s(F[7].Departure_Time,"06:55");
    strcpy_s(F[7].Arrival_Time,"14:30");
    strcpy_s(F[7].Duration,"7:35");
    ...
    strcpy_s(F[8].Flight_Number,"BA0232");
    strcpy_s(F[8].Flight_Company,"British Airways");
    strcpy_s(F[8].Source,"MUMBAI");
    strcpy_s(F[8].Destination,"LONDON");
    strcpy_s(F[8].Flight_Type,"International");
    F[8].Date_Of_Journey.day = 23;
    F[8].Date_Of_Journey.month = 6;
    F[8].Date_Of_Journey.year = 2023;
    strcpy_s(F[8].Departure_Time,"17:35");
    strcpy_s(F[8].Arrival_Time,"00:25");
    strcpy_s(F[8].Duration,"6:50");
    ...
    strcpy_s(F[9].Flight_Number,"6E0432");
    strcpy_s(F[9].Flight_Company,"Indigo");
    strcpy_s(F[9].Source,"DELHI");
    strcpy_s(F[9].Destination,"MUMBAI");
    strcpy_s(F[9].Flight_Type,"Domestic");
    F[9].Date_Of_Journey.day = 25;
    F[9].Date_Of_Journey.month = 11;
    F[9].Date_Of_Journey.year = 2023;
    strcpy_s(F[9].Departure_Time,"11:45");
    strcpy_s(F[9].Arrival_Time,"14:05");
    strcpy_s(F[9].Duration,"2:20");
    ...
    strcpy_s(F[10].Flight_Number,"AI6521");
    strcpy_s(F[10].Flight_Company,"Air India");
    strcpy_s(F[10].Source,"BANGALORE");
    strcpy_s(F[10].Destination,"CHENNAI");
    strcpy_s(F[10].Flight_Type,"Domestic");
    F[10].Date_Of_Journey.day = 26;
    F[10].Date_Of_Journey.month = 3;
    F[10].Date_Of_Journey.year = 2023;
    strcpy_s(F[10].Departure_Time,"09:15");
    strcpy_s(F[10].Arrival_Time,"10:40");
    strcpy_s(F[10].Duration,"1:25");
    ...
    strcpy_s(F[11].Flight_Number,"G80934");
    strcpy_s(F[11].Flight_Company,"Go Air");
    strcpy_s(F[11].Source,"DELHI");
    strcpy_s(F[11].Destination,"BANGALORE");
    strcpy_s(F[11].Flight_Type,"Domestic");
    F[11].Date_Of_Journey.day = 15;
    F[11].Date_Of_Journey.month = 6;
    F[11].Date_Of_Journey.year = 2023;
    strcpy_s(F[11].Departure_Time,"18:20");
    strcpy_s(F[11].Arrival_Time,"21:00");
    strcpy_s(F[11].Duration,"2:40");
    ...
    strcpy_s(F[12].Flight_Number,"AI7139");
    strcpy_s(F[12].Flight_Company,"Air India");
    strcpy_s(F[12].Source,"CHENNAI");
    strcpy_s(F[12].Destination,"MUMBAI");
    strcpy_s(F[12].Flight_Type,"Domestic");
    F[12].Date_Of_Journey.day = 20;
    F[12].Date_Of_Journey.month = 12;
    F[12].Date_Of_Journey.year = 2023;
    strcpy_s(F[12].Departure_Time,"16:00");
    strcpy_s(F[12].Arrival_Time,"17:25");
    strcpy_s(F[12].Duration,"1:25");
    ...
    strcpy_s(F[13].Flight_Number,"AX6609");
    strcpy_s(F[13].Flight_Company,"Air India Express");
    strcpy_s(F[13].Source,"BANGALORE");
    strcpy_s(F[13].Destination,"MUMBAI");
    strcpy_s(F[13].Flight_Type,"Domestic");
    F[13].Date_Of_Journey.day = 9;
    F[13].Date_Of_Journey.month = 10;
    F[13].Date_Of_Journey.year = 2023;
    strcpy_s(F[13].Departure_Time,"12:35");
    strcpy_s(F[13].Arrival_Time,"14:00");
    strcpy_s(F[13].Duration,"1:25");
    ...
    strcpy_s(F[14].Flight_Number,"SQ8559");
    strcpy_s(F[14].Flight_Company,"Singapore Airlines");
    strcpy_s(F[14].Source,"SINGAPORE");
    strcpy_s(F[14].Destination,"BANGALORE");
    strcpy_s(F[14].Flight_Type,"International");
    F[14].Date_Of_Journey.day = 26;
    F[14].Date_Of_Journey.month = 1;
    F[14].Date_Of_Journey.year = 2024;
    strcpy_s(F[14].Departure_Time,"20:15");
    strcpy_s(F[14].Arrival_Time,"02:25");
    strcpy_s(F[14].Duration,"6:10");
    ...
    strcpy_s(F[15].Flight_Number,"QF9834");
    strcpy_s(F[15].Flight_Company,"Qantas");
    strcpy_s(F[15].Source,"LONDON");
    strcpy_s(F[15].Destination,"DELHI");
    strcpy_s(F[15].Flight_Type,"International");
    F[15].Date_Of_Journey.day = 10;
    F[15].Date_Of_Journey.month = 10;
    F[15].Date_Of_Journey.year = 2023;
    strcpy_s(F[15].Departure_Time,"14:45");
    strcpy_s(F[15].Arrival_Time,"22:40");
    strcpy_s(F[15].Duration,"7:55");
    ...
    strcpy_s(F[16].Flight_Number,"BA9190");
    strcpy_s(F[16].Flight_Company,"British Airways");
    strcpy_s(F[16].Source,"LONDON");
    strcpy_s(F[16].Destination,"DELHI");
    strcpy_s(F[16].Flight_Type,"International");
    F[16].Date_Of_Journey.day = 7;
    F[16].Date_Of_Journey.month = 11;
    F[16].Date_Of_Journey.year = 2023;
    strcpy_s(F[16].Departure_Time,"15:45");
    strcpy_s(F[16].Arrival_Time,"23:20");
    strcpy_s(F[16].Duration,"7:35");
    ...
    strcpy_s(F[17].Flight_Number,"LH7994");
    strcpy_s(F[17].Flight_Company,"Lufthansa");
    strcpy_s(F[17].Source,"BERLIN");
    strcpy_s(F[17].Destination,"DELHI");
    strcpy_s(F[17].Flight_Type,"International");
    F[17].Date_Of_Journey.day = 15;
    F[17].Date_Of_Journey.month = 11;
    F[17].Date_Of_Journey.year = 2023;
    strcpy_s(F[17].Departure_Time,"18:20");
    strcpy_s(F[17].Arrival_Time,"04:45");
    strcpy_s(F[17].Duration,"10:25");
